      ...
      <div class="col-12 col-md-6 col-lg-4">
          <div class="card cardPhone">
              ...
              <div class="d-flex justify-content-between">
                  ...
                  <h3 class="cardPhone__title">${screen}</h3>
                  ...
                  <h3 class="cardPhone__title">${
                    type === "Iphone" ? "Iphone" : "Samsung"
                  }</h3>
                  </div>
              </div>
              <div class="d-flex justify-content-between">
  ...
  cart.forEach((item, index) => {
    ...
    content += `
      ...
      item.name
        ...
        <div class="col-2">
          <button class="btn btn-sm btn-secondary" id="btn-decrease-${
            item.id
          }">-</button>
          <span class="mx-2">${item.quantity}</span>
          <button class="btn btn-sm btn-secondary" id="btn-increase-${
            item.id
          }">+</button>
        </div>
        <div class="col-2">$${item.price}</div>
        <div class="col-1">
           <button class="btn btn-sm btn-danger" id="btn-remove-${
             item.id
           }">Xóa</button>
        </div>
      </div>
