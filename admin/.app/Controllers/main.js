...
const handleAdd = () => {
  ...
  isValid &=
    validation.checkEmpty(price, "tbGiaSP", "Please input price Product") &&
    validation.checkPrice(price, "tbGiaSP", "Please input price number");
  isValid &= validation.checkEmpty(
    screen,
    "tbScreenSP",
    "Please input screen Product"
  );
  isValid &= validation.checkEmpty(
    backCamera,
    "tbBackCameraSP",
    "Please input Backcamera Product"
  );
  isValid &= validation.checkEmpty(
    frontCamera,
    "tbFrontCameraSP",
    "Please input FrontCamera Product"
  );
  isValid &= validation.checkEmpty(
    img,
    "tbHinhSP",
    "Please input Image Product"
  );
